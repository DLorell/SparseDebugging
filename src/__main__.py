...
def main():
    ...
    parser.add_argument('-omp', default=False, type=str2bool, action='store', required=False, help="Whether or not to use batchOMP instead of TopK")

    args = parser.parse_args()

    run(lr=args.lr, depth=args.depth, augmentation=args.aug, 
        mparams=args.mparams, position=args.position, 
        fsmult=args.fsmult, kdiv=args.kdiv, 
        auxweight=args.auxweight, loadmodel=args.load, 
